...
function fillnextGames(data) {
    console.log("data",data);
        ...
        html += '<div class="flex flex-col items-center bg-blue-500 m-2 h-[35%] mt-2 w-[80%]"><div class="mb-2"><p class="text-white text-center text-lg font-bold text-xs">' +
            ...
            '</p></div><div></div><div class="flex items-center justify-between w-full"><div class="h-[5vh] w-[5vw] ml-[15%] mb-4"><img src="' +
            nextGames.team1.teamIconUrl +
            '></div><div class="text-2xl mt-2"><p class="text-white font-bold">:</p></div><div class="h-[4vh] w-[4vw] mr-[15%] mb-9"><img src="' +
            ...
            '</p></div><div class="text-center mr-[18.5%]"><p class="text-white align-text-bottom">' +
            nextGames.team2.teamName +
            '</p></div></div></div></div>'
            }
